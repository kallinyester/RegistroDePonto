...
$funcionarios = $dao->buscar_trainees();
...
<body>
    ...
    <div class="page-content">
        ...
        <ul>
            ...
            <li><a class="menu" href="evento.php">Presença em Eventos</a></li>
                ...
                <table id="table">
                    ...
                    <?php foreach ($funcionarios as $f): ?>
                        <tr>
                            ...
                            <td style='text-align: center; border-radius: 10px; background-color:rgb(186, 209, 214);'>Trainee🌱</td>
